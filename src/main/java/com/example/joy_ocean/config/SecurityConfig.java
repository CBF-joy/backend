package com.example.joy_ocean.config;

import com.example.joy_ocean.security.CustomUserDetailsService;
import com.example.joy_ocean.security.JwtAuthenticationEntryPoint;
import com.example.joy_ocean.security.JwtAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests() //다음 리퀘스트에 대한 사용권한 체크
                    ...
                    .antMatchers(HttpMethod.GET, "/api/getIngExhibition", "/api/getIngExhibition/**","/api/getIngExhibitionDetail/**",
                            "/api/getComment/**", "/api/getAvgRate/**" , "/api/fetchRate/**", "/api/getPreExhibition",
                            "/api/getIngAuction", "/api/getAuctionDetail/**","/api/getAuctionByToken/**","/api/getCountPostByExhibit/**",
                            "/api/getAvgBid/**", "/api/getCountBid/**", "/api/getMaxBid/**", "/api/getExhibitionRankingBySumPostKlay")
                        .permitAll()
                    .antMatchers(HttpMethod.POST, "/saveFav/**")
                        .permitAll()
                    .antMatchers(HttpMethod.PUT, "/deleteToonThumbnail/**")
                        .permitAll()  
